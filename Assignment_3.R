...
vector_a = c("My","name","is")
vector_b = c("Shilo","Farrar","Crook")
...
plot(nums, main = "My Title", xlab = "My axis label", 
     ylab = "My other axis label", col = "Black",
     cex = .5, pch = 5)


jpeg(filename = "C://Users/Shilo/Desktop/image.jpeg")
plot(nums, main = "My Title", xlab = "My axis label", 
     ylab = "My other axis label", col = "Black",
     cex = .5, pch = 5)
dev.off()
...
bad2 = which(dat$Headwidth == 1)

dat$Headwidth[bad2] = NA
...
write.csv(dat2, file = "C://Users/Shilo/Desktop/Data_Course_Crook/", row.names = FALSE)
